	...
	>
		<el-form ref="dataFormRef" :model="state.formdata" :rules="dataRules" label-width="120px">
			<el-form-item prop="code" label="仓库编码">
				<el-input v-model="state.formdata.code" placeholder="仓库编码" />
			</el-form-item>
			<el-form-item prop="name" label="仓库名称">
				<el-input v-model="state.formdata.name" placeholder="仓库名称" />
			</el-form-item>
...
import { createOrUpdate } from '@/api/basicdata/warehouse'
import { EditWarehouse } from '@/types/basicdata/warehouse'
...
const getDefaultFormData = (): EditWarehouse => {
	return {
		code: '',
		name: '',
		enabled: true
