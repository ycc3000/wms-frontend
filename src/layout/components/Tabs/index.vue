<template>
	<div class="tabs-container">
		<div class="tabs-item">
			<el-tabs v-model="activeTabName" :class="tabsStyleClass" @tab-click="onClick" @tab-remove="onRemove">
...
import { useTabsStore, useAppStore, useRouterStore } from '@/store'
